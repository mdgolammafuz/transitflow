...
Ensures Phase 1 Pydantic models correctly parse and validate raw HSL data.
"""
...
class TestVehiclePosition:
    ...
    def test_valid_position(self):
        """Basic valid position for Jan 2026."""
        pos = VehiclePosition(
            vehicle_id=1234,
            timestamp=datetime(2026, 1, 7, 10, 0, 0, tzinfo=timezone.utc),
            latitude=60.17,
            longitude=24.94,
            speed_ms=12.5,
            heading=180,
        ...
        # Corrected epoch for 2026-01-07 10:00:00 UTC
        assert pos.event_time_ms == 1767780000000
