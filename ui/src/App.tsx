...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        ⚠️ <strong>Demo Limitation:</strong> Backend unavailable on free tier (512MB RAM insufficient).{" "}
        <a
          href="https://github.com/mdgolammafuz/IntelSent"
        ...
        for full functionality or see{" "}
        <a
          href="https://intelsent.onrender.com/docs"
          style={{ color: "#0066cc", textDecoration: "underline" }}
          target="_blank"
          rel="noopener noreferrer"
        >
