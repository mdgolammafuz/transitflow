 ...
 * * Enforces Principle #2: Immutable Truth (INSERT only).
 */
public class PostgresBronzeSink {
    ...
    public SinkFunction<HourlyAggregate> createSink() {
        String insertSQL = """
            INSERT INTO bronze.hourly_pm25 (
    ...
    public SinkFunction<PM25Reading> createRawSink() {
        ...
        return JdbcSink.sink(
            ...
            (statement, reading) -> {
                ...
                if (reading.getLatitude() != null) statement.setDouble(5, reading.getLatitude());
                else statement.setNull(5, java.sql.Types.DOUBLE);
                
                if (reading.getLongitude() != null) statement.setDouble(6, reading.getLongitude());
